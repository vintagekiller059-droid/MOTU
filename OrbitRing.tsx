...
export const OrbitRing: React.FC = () => {
  ...
  const speed1 = getSpeed(90);
  const speed2 = getSpeed(60);
  const speed3 = getSpeed(45);
  const speed4 = getSpeed(30);
  ...
  return (
    <div className="absolute inset-0 w-full h-full flex items-center justify-center pointer-events-none z-10">
      ...
      <div
        className="absolute w-[560px] h-[560px] rounded-full border border-[#00E5FF]/15 flex items-center justify-center animate-orbit-ring-1"
      ...
      <div
        className="absolute w-[490px] h-[490px] rounded-full border-2 border-[#00E5FF]/30 shadow-[0_0_20px_rgba(0,229,255,0.15)] flex items-center justify-center animate-orbit-ring-2"
      ...
      <div
        className="absolute w-[420px] h-[420px] rounded-full border border-dashed border-[#00E5FF]/20 flex items-center justify-center animate-orbit-ring-3"
        style={{ animationDuration: `${speed3}s` }}
      >
      ...
      <div
        className="absolute w-[330px] h-[330px] rounded-full border border-[#38FFD1]/20 flex items-center justify-center animate-orbit-ring-4"
        style={{ animationDuration: `${speed4}s` }}
      >
